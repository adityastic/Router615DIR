...
public class AdityaMenuView extends RelativeLayout {
    ...
    public AdityaMenuView(Context context) {
        this(context, null);
    }

    public AdityaMenuView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AdityaMenuView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void readAttributes(AttributeSet attributeSet) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attributeSet, R.styleable.AdityaMenuView);

        try {
            mBackgroundDrawableId = typedArray.getResourceId(R.styleable.AdityaMenuView_background, DEFAULT_DRAWABLE_ATTRIBUTE_VALUE);
            mHeaderViewId = typedArray.getResourceId(R.styleable.AdityaMenuView_header, DEFAULT_LAYOUT_ATTRIBUTE_VALUE);
            mFooterViewId = typedArray.getResourceId(R.styleable.AdityaMenuView_footer, DEFAULT_LAYOUT_ATTRIBUTE_VALUE);
        } finally {
            typedArray.recycle();
        }
    }
    ...
    private void initialize() {
        ViewGroup rootView = (ViewGroup) inflate(getContext(), R.layout.navigation_view_menu, this);
