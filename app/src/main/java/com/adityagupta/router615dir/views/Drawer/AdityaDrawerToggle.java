 ...
 * has occurred.</p>
 * <p>
 * <p><code>AdityaDrawerToggle</code> can be used directly as a
 * {@link DrawerListener}, or if you are already providing
...
public class AdityaDrawerToggle implements DrawerListener {
     ...
     * <p>
     * Please use {@link #AdityaDrawerToggle(Activity, AdityaNavigationLayout, Toolbar, int, int)}  if you are
    ...
    <T extends Drawable & DrawerToggle> AdityaDrawerToggle(Activity activity, Toolbar toolbar,
        ...
        mAdityaNavigationLayout = AdityaNavigationLayout;
     ...
     * may have diverged in such a way that the AdityaDrawerToggle was not notified.
     * (For example, if you stop forwarding appropriate drawer events for a period of time.)</p>
     */
    public void syncState() {
        if (mAdityaNavigationLayout.isDrawerOpen(GravityCompat.START)) {
        ...
        if (mDrawerIndicatorEnabled) {
            setActionBarUpIndicator((Drawable) mSlider,
                    mAdityaNavigationLayout.isDrawerOpen(GravityCompat.START) ?
    ...
    private void toggle() {
        if (mAdityaNavigationLayout.isDrawerVisible(GravityCompat.START)) {
            mAdityaNavigationLayout.closeDrawer(GravityCompat.START);
        } else {
            mAdityaNavigationLayout.openDrawer(GravityCompat.START);
        }
    }
    ...
    public void setHomeAsUpIndicator(int resId) {
        ...
        if (resId != 0) {
            indicator = mAdityaNavigationLayout.getResources().getDrawable(resId);
        }
    ...
    void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
        if (!mWarnedForDisplayHomeAsUp && !mActivityImpl.isNavigationVisible()) {
            Log.w("AdityaDrawerToggle", "DrawerToggle may not show up because NavigationIcon"
    ...
    private static class HoneycombDelegate implements Delegate {
        ...
        AdityaDrawerToggleHoneycomb.SetIndicatorInfo mSetIndicatorInfo;
        ...
        public Drawable getThemeUpIndicator() {
            return AdityaDrawerToggleHoneycomb.getThemeUpIndicator(mActivity);
        }
        ...
        public void setActionBarUpIndicator(Drawable themeImage, int contentDescRes) {
            ...
            mSetIndicatorInfo = AdityaDrawerToggleHoneycomb.setActionBarUpIndicator(
        ...
        public void setActionBarDescription(int contentDescRes) {
            mSetIndicatorInfo = AdityaDrawerToggleHoneycomb.setActionBarDescription(
